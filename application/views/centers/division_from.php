                ...
                <div class="page-body ra_bodyHeader">
                    <div class="widget ra_widgetMarginBody">
                        <div class="widget-header ra_bodyHeaderTitleIcon">
                            ...
                            <span class="widget-caption"> Division Details</span>
                        ...
                        <div class="widget-body">
                            <form id="registrationForm" method="post" class="form-horizontal"
                                ...
                                data-bv-feedbackicons-validating="glyphicon glyphicon-refresh" action="<?=site_url('centers/addEditDivision')?>">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        <div class="widget radius-bordered">
                                            ...
                                            <div class="widget-header bg-blue">
                                                <span class="widget-caption">Division Information</span>
                                            </div>
                                            ...
                                            <div class="widget-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="text" class="form-control input-sm" name="description"  placeholder="Division Name"
                                                               data-bv-message="The Division Name is not valid"
                                                               required
                                                               data-bv-notempty-message="The Division Name is required and cannot be empty"
                                                               pattern="[a-zA-Z0-9]+"
                                                               data-bv-regexp-message="The Division Name can only consist of alphabetical, number" 
                                                               data-bv-stringlength="true"
                                                               data-bv-stringlength-min="2"
                                                               data-bv-stringlength-max="20"
                                                               data-bv-stringlength-message="The Division Name must be more than 5 and less than 20 characters long" 
                                                               value='<?= $description; ?>' />
                                                    </div>
                                                </div>
