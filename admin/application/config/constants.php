...
/*
defined('DATABASE_HOST')      OR define('DATABASE_HOST', '192.168.10.227');
defined('DATABASE_USER')      OR define('DATABASE_USER', 'rabbany');
defined('DATABASE_PASSWORD')  OR define('DATABASE_PASSWORD', 'l00k@me');
defined('DATABASE_NAME')      OR define('DATABASE_NAME', 'gameanim');
