...
<head>
    ...
    <link type="text/css" id="bootstrap-rtl-link" href="#" rel="stylesheet" />
    <link type="text/css" href="<?=base_url()?>assets/css/font-awesome.min.css" rel="stylesheet" />
    <link type="text/css" href="<?=base_url()?>assets/css/weather-icons.min.css" rel="stylesheet" />
    ...
    <!--Beyond styles-->
    <link type="text/css" href="<?=base_url()?>assets/css/beyond.min.css" rel="stylesheet" />
    <link type="text/css" href="<?=base_url()?>assets/css/typicons.min.css" rel="stylesheet" />
    <link type="text/css" href="<?=base_url()?>assets/css/animate.min.css" rel="stylesheet" />
    <link id="skin-link" href="#" rel="stylesheet" type="text/css" />
    <link type="text/css" href="<?=base_url()?>assets/css/ra.css" rel="stylesheet" />
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <!--End Examination-->
                    <li>
                        <a href="<?=site_url('apps/getUserDetails')?>">
                            <i class="menu-icon glyphicon glyphicon-home"></i>
                            <span class="menu-text"> User Details </span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=site_url('apps/qusImport')?>">
                            <i class="menu-icon glyphicon glyphicon-home"></i>
                            <span class="menu-text"> Import Questions</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=site_url('apps/quizResultNew')?>">
                            <i class="menu-icon glyphicon glyphicon-home"></i>
                            <span class="menu-text"> Quizs Result </span>
                        </a>
                    </li>
