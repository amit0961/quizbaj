                    ...
                    <div class="widget ra_widgetMarginBody">
                        <div class="widget-header ra_bodyHeaderTitleIcon">
                            ...
                            <div class="widget-buttons">
                                <a href="<?=site_url('centers/addFormDivision/0')?>">
                                    <i class="fa fa-plus blue"></i> New Division
                                </a>
                            </div><!--Widget Buttons-->
                        </div><!--Widget Header-->
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td class="raTableBodyNR">  
                                                ...
                                                <a href="<?=site_url('centers/deleteDivision/'.$row->id)?>" class="btn btn-danger btn-xs delete" onclick="return confirm('Do you really want to remove this division?')"><i class="fa fa-trash-o"></i> Delete</a>
                                            </td> 
                                        </tr>                                                                                                                                                        
                            <?php        
...
<script>
    ...
    function dopagination(pageNumber)
    {
        ...
        var url = "<?=site_url("centers/divisionListPagination")?>";
        var myRandom = parseInt(Math.random()*99999999); // cache buster
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.open("GET", url + "/" + escape(pageNumber) + "/"  + escape(limit) + "/" + escape(description)  + "/" + myRandom, true);
        xmlhttp.send(null);
    }
    ...
    function searchResult()
    {
        ...
        var myRandom = parseInt(Math.random()*99999999); // cache buster
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.open("GET", url + "/" + escape(startoffset) + "/"  + escape(limit) + "/" + escape(description) + "/" + myRandom, true);
        xmlhttp.send(null);
    }
