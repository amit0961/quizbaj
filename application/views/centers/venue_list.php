            ...
            <div class="page-content">
                ...
                <div class="page-header position-relative">
                    <div class="header-title">
                        <h5> Traning Venue Information</h5>
                    </div>
                    ...
                    <div class="widget ra_widgetMarginBody">
                        <div class="widget-header ra_bodyHeaderTitleIcon">
                            ...
                            <div class="widget-buttons">
                                <a href="<?=site_url('centers/addFormVenue/0')?>">
                                    <i class="fa fa-plus blue"></i> New Venue
                                </a>
                            </div><!--Widget Buttons-->
                        </div><!--Widget Header-->
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" class="ra_SeachTDPaddingRight">
                                    <div class="form-group ra_form-group">
                                        <span class="input-icon">
                                            <input type="text" name="description" id="description" class="form-control input-sm" placeholder="Venue Name"><i class="fa fa-map-marker blue"></i>
                                          </span>
                                    </div>
                                </td>
                                ...
                                <td align="left" class="ra_SeachTDPaddingRight">
                                    <div class="form-group ra_form-group">
                                        <span class="input-icon">
                                            <select name="upazilaID" id="upazilaID" class="form-control input-sm">
                                                <?=$upazilaList?>
                                            </select> 
                                          </span>
                                    </div>
...
<script>
    ...
    function dopagination(pageNumber)
    {
        ...
        var upazilaID=document.getElementById("upazilaID").value;
        ...
        var url = "<?=site_url("centers/traningVenueListPagination")?>";
        var myRandom = parseInt(Math.random()*99999999); // cache buster
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.open("GET", url + "/" + escape(pageNumber) + "/"  + escape(limit) + "/" + escape(description) + "/" + escape(upazilaID)  + "/" + myRandom, true);
        xmlhttp.send(null);
    }
    ...
    function searchResult()
    {
        ...
        var myRandom = parseInt(Math.random()*99999999); // cache buster
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.open("GET", url + "/" + escape(startoffset) + "/"  + escape(limit) + "/" + escape(description) + "/" + escape(upazilaID) + "/" + myRandom, true);
        xmlhttp.send(null);
    }
